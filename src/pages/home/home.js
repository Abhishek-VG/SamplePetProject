    ...
    <div>
      <Box sx={{ display: "flex" }}>
          ...
          <Toolbar id="toolbar" style={{ paddingLeft: 0 }}>
            <Typography
              ...
              style={{
                ...
                height: "67px",
                width: "116px",
              }} /* variant="h6" noWrap component="div" style={{ textAlignVertical: "center", textAlign: "center", }} */
            ></Typography>
          </Toolbar>
        </AppBar>
        <Drawer variant="permanent" open={open}>
            ...
            <Divider />
            <List style={text}>
            <div style={{backgroundImage: "url(/images/leftbg.jpg)",backgroundSize:"cover", height:"802px", backgroundattach:"fixed",}}>
            ...
            >
              <Grid
                ...
                container
              >
                <div>{open ? <ArrowBackIcon /> : <ArrowForwardIcon />}</div>
              </Grid>
            </IconButton>
              </div>
